...
This project is indexed by GitNexus as **UEvent-Frontend** (1583 symbols, 3067 relationships, 117 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
