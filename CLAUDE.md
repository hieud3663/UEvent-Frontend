...
This project is indexed by GitNexus as **UEvent-Frontend** (2406 symbols, 4914 relationships, 179 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
