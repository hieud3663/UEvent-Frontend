...
This project is indexed by GitNexus as **UEvent-Frontend** (2210 symbols, 4402 relationships, 164 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
