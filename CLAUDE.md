...
This project is indexed by GitNexus as **UEvent-Frontend** (1501 symbols, 2953 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
