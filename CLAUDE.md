...
This project is indexed by GitNexus as **UEvent-Frontend** (2082 symbols, 4236 relationships, 157 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
