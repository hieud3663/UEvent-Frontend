...
This project is indexed by GitNexus as **UEvent-Frontend** (1485 symbols, 2937 relationships, 109 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
