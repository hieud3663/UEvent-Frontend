...
This project is indexed by GitNexus as **UEvent-Frontend** (2146 symbols, 4313 relationships, 158 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
