...
This project is indexed by GitNexus as **UEvent-Frontend** (1847 symbols, 3719 relationships, 137 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
