// File: lib/features/events/widgets/reply_editor_card.dart
                ...
                Row(
                  children: [
                    InkWell(
                      ...
                      child: const Icon(Icons.attachment, color: AppColors.navInactive, size: 20),
                    ),
                    const SizedBox(width: 16),
                    InkWell(
                      onTap: widget.onEmoji,
                      child: const Icon(Icons.mood, color: AppColors.navInactive, size: 20),
                    ),
                  ],
                ),
                Text(
