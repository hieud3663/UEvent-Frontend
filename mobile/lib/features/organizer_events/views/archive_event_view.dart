// File: lib/features/organizer_events/views/archive_event_view.dart
...
class ArchiveEventView extends StatelessWidget {
  ...
  const ArchiveEventView({super.key, this.onBack});
