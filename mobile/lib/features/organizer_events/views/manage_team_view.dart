// File: lib/features/organizer_events/views/manage_team_view.dart
...
import 'package:frontend/features/event_shared/widgets/info_bento_card.dart';
...
class _ManageTeamViewState extends ConsumerState<ManageTeamView> {
  ...
  Future<void> _promoteCandidate(
    ...
    if (ok) {
      ...
      showAppSnackBar(sheetContext, 'Không cấp được quyền co-host.');
    }
  }
}
