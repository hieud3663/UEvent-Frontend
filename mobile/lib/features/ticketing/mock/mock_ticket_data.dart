...
class MockTicketData {
  static final TicketModel myValidTicket = TicketModel(
    id: 'ticket-001',
    eventId: 'event-001',
    eventName: 'Tiệc ra mắt UEvent 2026',
  ...
  static final List<TicketModel> upcomingTickets = [myValidTicket];

  static final List<TicketModel> pastTickets = [
    myValidTicket.copyWith(
      id: 'ticket-002',
      eventName: 'Hội nghị Công nghệ Tương lai 2024',
      date: '24/10/2024',
  ...
  static const String attendanceSummary =
      'Bạn đã tham gia 1 sự kiện trong tháng này.';
}
