...
import { Database, Settings, Shield, ShieldAlert, Network, Info } from 'lucide-react';
...
export default function PermissionsPage() {
  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      {/* Bento Grid Permission UI */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* User Summary Card (Glass) */}
        <div className="col-span-1 lg:col-span-4 h-full">
          <div className="bg-white/70 backdrop-blur-2xl p-6 rounded-[24px] border border-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.04)] sticky top-24">
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <p className="text-sm text-slate-500 font-medium">s.jenkins@amberglass.sys</p>
            ...
            <div className="space-y-4 pt-6 border-t border-slate-200/50">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-bold text-slate-900">42 / 120</span>
              </div>
              ...
              <div className="p-4 bg-amber-50 rounded-xl mt-4">
                <div className="flex gap-3">
                  ...
                  <p className="text-xs leading-relaxed text-amber-800/80 font-medium">
                    This user has custom overrides active that deviate from the standard{' '}
                    <span className="font-bold">Analyst</span> role template.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="col-span-1 lg:col-span-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50/50 rounded-xl border border-transparent hover:border-amber-500/20 hover:bg-white transition-all group">
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-slate-800">Read Encryption Keys</span>
                  <span className="text-xs text-slate-500">Access to sensitive root certificates</span>
                </div>
                <label className="relative inline-flex items-center cursor-pointer shrink-0 ml-4">
                  <input
                    type="checkbox"
                    checked={dataAccess.keys}
                    onChange={() => setDataAccess((p) => ({ ...p, keys: !p.keys }))}
              ...
              {/* Permission Item: Schemas */}
              <div className="flex items-center justify-between p-4 bg-slate-50/50 rounded-xl border border-transparent hover:border-amber-500/20 hover:bg-white transition-all group">
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-slate-800">Modify DB Schemas</span>
                  <span className="text-xs text-slate-500">Structural changes to production tables</span>
                </div>
                <label className="relative inline-flex items-center cursor-pointer shrink-0 ml-4">
                  <input
                    type="checkbox"
                    checked={dataAccess.schema}
                    onChange={() => setDataAccess((p) => ({ ...p, schema: !p.schema }))}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-amber-500"></div>
                </label>
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50/50 rounded-xl border border-transparent hover:border-amber-500/20 hover:bg-white transition-all group">
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-slate-800">PII De-masking</span>
                  <span className="text-xs text-slate-500">View customer identities in cleartext</span>
                </div>
                <label className="relative inline-flex items-center cursor-pointer shrink-0 ml-4">
                  <input
                    type="checkbox"
                    checked={dataAccess.pii}
                    onChange={() => setDataAccess((p) => ({ ...p, pii: !p.pii }))}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-amber-500"></div>
                </label>
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50/50 rounded-xl border border-transparent hover:border-amber-500/20 hover:bg-white transition-all group">
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-slate-800">Mass Export</span>
                  <span className="text-xs text-slate-500">Permission to download datasets &gt;10k</span>
                </div>
                <label className="relative inline-flex items-center cursor-pointer shrink-0 ml-4">
                  <input
                    type="checkbox"
                    checked={dataAccess.export}
                    onChange={() => setDataAccess((p) => ({ ...p, export: !p.export }))}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-amber-500"></div>
                </label>
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-50/50 rounded-xl gap-4">
                ...
                <div className="flex items-center gap-3 shrink-0 self-end sm:self-auto">
                  <span className="px-3 py-1 bg-red-100 text-red-600 text-[10px] font-bold rounded-full whitespace-nowrap">
                    High Risk
                  </span>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={adminOps.policy}
                      onChange={() => setAdminOps((p) => ({ ...p, policy: !p.policy }))}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-amber-500"></div>
                  </label>
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50/50 rounded-xl">
                ...
                <label className="relative inline-flex items-center cursor-pointer shrink-0 ml-4">
                  <input
                    type="checkbox"
                    checked={adminOps.topology}
                    onChange={() => setAdminOps((p) => ({ ...p, topology: !p.topology }))}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-amber-500"></div>
                </label>
          ...
          <div className="flex flex-wrap gap-3">
            {['Audit Reporting', 'Webhooks v2', 'API Key Rotation', 'Tenant Isolation', 'Session Management'].map((scope) => (
              <button
                key={scope}
