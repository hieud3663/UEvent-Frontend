    ...
    <main className="min-h-screen bg-surface-container-low text-on-surface">
      <header className="border-b border-neutral-200 bg-white">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
          ...
          <Link
            href="/download"
            className="inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-primary-container px-4 text-sm font-bold text-on-primary-container transition hover:shadow-lg hover:shadow-primary-container/30"
          >
      ...
      <div className="mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:py-10">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <h1 className="max-w-4xl text-3xl font-black tracking-tight text-neutral-900 sm:text-4xl">
              {event.title}
            </h1>
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
          <div className="space-y-6">
            <Card className="overflow-hidden p-0">
              <div className="relative aspect-[16/7] min-h-64 bg-neutral-100">
                <Image
                  src={coverImage}
                  alt={event.title}
                  fill
          ...
          <aside className="space-y-6">
            ...
            <Card>
              ...
              <Link
                href={appDeepLink}
                className="mt-5 inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-primary-container px-4 text-sm font-bold text-on-primary-container transition hover:shadow-lg hover:shadow-primary-container/30"
              >
              ...
              <Link
                href="/download"
                className="mt-3 inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-neutral-200 bg-white px-4 text-sm font-bold text-neutral-700 transition hover:bg-neutral-50"
              >
                <Download className="h-4 w-4" />
                Tải ứng dụng
              </Link>
